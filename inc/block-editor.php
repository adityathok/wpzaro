...
add_action( 'after_setup_theme', 'wpzaro_block_editor_setup' );

if ( ! function_exists( 'wpzaro_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function wpzaro_block_editor_setup() {
...
if ( ! function_exists( 'wpzaro_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function wpzaro_generate_color_palette() {
		$color_palette = array();
