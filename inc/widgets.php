...
if ( ! function_exists( 'wpzaro_widgets_init' ) ) {
	...
	function wpzaro_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'wpzaro' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'wpzaro' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'wpzaro' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'wpzaro' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'wpzaro' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'wpzaro' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'wpzaro' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'wpzaro' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'wpzaro' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'wpzaro' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'wpzaro' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'wpzaro' ),
